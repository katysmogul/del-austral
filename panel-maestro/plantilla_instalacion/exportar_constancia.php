...
// Calculamos la carpeta real donde vive este script (ej:
// "/hospital-regional/"), en vez de asumir que el sitio está en
// la raíz del dominio — necesario porque cada institución vive
// en su propia subcarpeta.
$carpetaActual = str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']);
$urlValidacion = 'https://' . $_SERVER['HTTP_HOST'] . $carpetaActual . 'validar_constancia.php?token=' . urlencode($constancia['token']);
