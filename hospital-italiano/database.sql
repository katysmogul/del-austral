...
-- ------------------------------------------------------------
-- Tabla: reportes_bug (reportes de problemas enviados por el
-- Apoderado al equipo de soporte). El estado y las respuestas se
-- gestionan desde el panel maestro, que se conecta puntualmente
-- a esta base para leerlos y actualizarlos.
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Tabla: salud_sistema (clave/valor genérico para señales de
-- monitoreo: última corrida de cada cron, última actividad
-- real, etc). El panel maestro lee esta tabla conectándose
-- puntualmente a la base de cada institución.
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Tabla: errores_app (log de errores fatales/excepciones de
-- PHP, capturados por el propio código en vez de depender del
-- log del servidor, que varía según el hosting).
-- ------------------------------------------------------------
