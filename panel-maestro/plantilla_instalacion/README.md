...
- 🏷️ **Nombre de institución personalizable**: "Del Austral" no está fijo en el código — se configura desde el panel del Desarrollador y se aplica en toda la interfaz (título, login, PDF exportados, app instalable), pensado para poder ofrecer el sistema a distintas instituciones con su propia identidad.
