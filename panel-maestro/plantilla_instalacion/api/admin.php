...
if ($accion === 'historial') {
    ...
    if ($rol === 'desarrollador') {
        // El Apoderado ve TODO el historial, sin acotar a
...
// apoderado. Resumen agregado de cada sede activa: cuántos
...
// solo apoderado. Profesionales activos cuya licencia
...
// apoderado. Compara el contenido real de los archivos
